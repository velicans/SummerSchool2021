...
public class WinesApi {
    ...
    public static final String WINE_NAME = "vin de masa";
    ...
    public String getWineId(String wineName) {
        ...
        return JsonPath.with(response.prettyPrint()).get("find { a -> a.composition[0] == '" + wineName + "'}.id").toString();
    }
    ...
    public Boolean isWineAvailable(String wineName) {
        ...
        return JsonPath.with(response.prettyPrint()).get("composition[0]").toString().contains(wineName);
    }

    public void deleteWine(String grapeName) {

        String id = getWineId(grapeName);
        deleteWineById(id);
    }

    private void deleteWineById(String id) {
