...
public class WineyardPO {
    ...
    public void addNewGrape(String grapeName, int grapeAge, int grapeRipeness){
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(age))).sendKeys(String.valueOf(grapeAge));

        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(ripeness))).clear();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(ripeness))).sendKeys(String.valueOf(grapeRipeness));
